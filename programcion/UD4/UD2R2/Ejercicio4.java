        ...
        while (opcion != 4) {
            ...
            if (opcion == 1) {
                ...
                if(libros.isEmpty()){
                    ...
                    //para ver el inventario completo necesitamos un for por que al ser dos listas separadas necesitas un indice(variable i) que recorra ambas listas a la vez. 
                    for ( int i=0 ; i <libros.size(); i++ ){
                        String nombre= libros.get(i); //obtenemos el nombre de la posicion i 
                        int stock = cantidad.get(i); //obtenemos la cantidad de la misma posicion anterior i
                        //luego lo imprimimos en la siguiente linea.
                        System.out.println((i+1) + " , "+ nombre+ " - Stock: "+ stock);
                        // (i+1) esto es para que en la lista me muestre un listado como tal y no un 0 al comienzo de la lista. 
