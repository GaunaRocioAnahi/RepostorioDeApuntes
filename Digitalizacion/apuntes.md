...
- reduccion de desplazamiento.
- monitoreo mas efectivo del mundo ambiente


**RETO PROFESIONAL**
LA CRACION DE UNA TIENDA POR PARTE DE PEDRO PUEDE TENER UN EFECTO POSITIVO, EN EL MEDIO AMBIENTE, AL REDUCIR LA HUELLA DE CARBONO ASOCIADA AL TRANSPORTE DE LOS CLIENTE Y A LA INFRAESTRUCTURA. 


daño al medio hambiente, Practicas empresiariales. 
practicas sostenibles. estas practicas estas diseñadas para minimizar el impacto negativo de las operaciones.
...
Impacto de las THD  de las empresas, Su impacto puede diferenciarse en dos categorias: tecnologia de la informacion, relacionadads con el amacenamietno, la proteccion, el procesamiento y transmision de datos o de informacion digitalizacion, Tecnologia de la operacion (relacionadas con el efecto en la monitorea y controla la produccion y la cadena de suministro en entornos industriales.)
ejemplos las CRM.

THD y tecnologia de la informacion. 
las THD y tegnologia de la inforamcion,



THD y tegnologia de las operaciones. 
thd han evolucionados de la forma em la
...
como tecnologia habilitadora digitales: son todas las herramientas y los recursos tecnologicos, que impulsan la innovacion y el desarrollo digital, resultan escenciales para la transformacion digital de todos los sectores productivos y son protagonista de la industria 4.0 ¿cuales son? 
inteligencia artificial, 
son algoritmos y tecnicas que permiten a las maquinas, aprender y razonar, y tomar decisiones. BIG DATA y analisis de datos, capacidad de recopilar, almacenar y analizar grandes volumenes de datos para extraer informacion valiosa.
internet de las cosas: conexion de dispositivos y objetos fisicos, a internet que permiten la recopiacion de datos en tiempo real y la automatizacion de procesos 
robotica robots y automatizacion roboticas de procesos que desempeñan un papel importante en la automatizacion de tareas y procesos, 
realidad virtual y realidad aumentda
realidad aumentada enriquese el entorno real con elemento digitales, 
mientras que la realidad vistural crea un entorno simmulado 
blockchenk: proporciona un registro deshentralizado y seguro de transsaciones 
biometria: emplea huellas dactilares reconocimiento facila y voz para la autenticacion y la seguridad.
5g:Proporciona una conectividad, mas rapida y confiable.
imprecion 3D fabricacion de objetos tridimentcionales.
computacion en la nube :proporciona y procesamiento y amacenamiento de datos atraves de internet.
ciber seguridad tecnologia y buenas practicas, que protejen sistemas redes y datos de amenazas ciberneticas.
---
Caracteristicas de la THD. 

versatilidad, automatizacion, interconexion, analitica avanzada seguridad
escalabilidad, personalizacion, ahorro, e inovacion.

impacto de las THD en las empresas.

tegnologia de la informacion, relacionada con el almacenamiento la proteccion, el procesamiento y la transmision de datos con informacion digital.

la tegnologia de la operacion:
relacionada con el efecto en la monitorizacion. y con el control de la produccion, y la cadena de suministros en entornos industriales. 
imparto de las THD, en el medio hambiente, disminusion den el uso de papel graccias a la gesion electronica
mayor eficiencia energita por la autoatizacion de sistemas de climatizacion.
reduccion de desplazamiento la expancion por la existencia de teletrabajo
monitoreo gracias a sensoles drones y herramientas digitales. 
